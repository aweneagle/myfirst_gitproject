<?php
    ...
    define("CORE_ERR_JOB_ROUTING", 9);
    define("CORE_ERR_IO_ROUTING", 10);
    define("CORE_ERR_SET_JOBROUTER", 11);
    define("CORE_ERR_SET_IOROUTER", 12);
    define("CORE_ERR_JOB_RUNING", 13);
