...
type NetEvent struct {
	...
	/* 端口监听 */
	ports	map[int] ne_port


	/* 连接 */
	conns	map[uint32] ne_conn
...
/* 获取一个端口实例 */
func (ne *NetEvent) Port(port int) *NetPort {}
...
*/
func (ne *NetEvent) Listen(port int, is_sync bool) error {}
 ...
 *
 */
func (nc *NetConn) Connect(host string, port int) error {
}
...
*
*/
func (nc *NetConn) Dial(host string, port int) error {
}
...
/* 获取connect信息 
*/
func (nc *NetConn) Info() *net_conn_info {
}
